...
def litCricFriend(wordList, text):
    ...
    # Three lines of code.
    newBellsv4 = []
    for word in newBellsv3:
        newBellsv4.append(word.strip(string.punctuation))
...
print('bellsAAnFrequency is ' + str(litCricFriend(['a','an'],theBells)))
print('bellstheFrequency is ' + str(litCricFriend(['the'],theBells)))
print('bellsAAnFrequency is ' + str(litCricFriend(['a','an'],cantoXII)))
print('bellstheFrequency is ' + str(litCricFriend(['the'],cantoXII)))
...
# differently?
'''Neruda seems to use a and an more than poe, who uses the more, so yes, they use definite and indefinite articles 
differently. '''